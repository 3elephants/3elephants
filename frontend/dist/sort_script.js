...
},{}],"sort_script.js":[function(require,module,exports) {
"use strict";
...
$(function () {
  ...
  function sortList(sortOrder, list, b) {
    ...
    list.innerHTML = s; // $("#loading").css("display","none");
  }

  function getAllTheSortScores(list, b) {
    var products = []; // document.getElementsByTagName("body")[0].innerHTML +='<div id="loading"> <div id="loading-image"class="loader"></div></div>';
  ...
  chrome.storage.sync.get({
    ...
    if (list == null) {
      if (document.getElementsByClassName("s-result-list") == undefined) return;
      list = document.getElementsByClassName("s-result-list")[0]; //for different layout
    }

    b = list.children;
    if (items.toSort) getAllTheSortScores(list, b);
  });
});
},{"./lib/constants":"lib/constants.js"}],"../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","sort_script.js"], null)
//# sourceMappingURL=sort_script.map