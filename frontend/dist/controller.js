...
},{"./constants":"lib/constants.js","./menu/options_manager":"lib/menu/options_manager.js"}],"lib/shipping.js":[function(require,module,exports) {
"use strict";
...
function create(data) {
  ...
  var updateLogic = function updateLogic(params) {
    if ((0, _utils.exists)(document.getElementById('elephant-shipping-span'))) {
      return;
    }

    if ((0, _utils.exists)(document.getElementsByClassName(".shipping-speed .ship-option")[1])) {
    ...
    for (var i = 0; i < length; i++) {
      var text = $(".shipping-speed.ship-option").eq(i).find(".a-color-secondary").text(); //Based on text assign variable

      if (text.search("trialof") != -1) studentShipping = $(".shipping-speed.ship-option").eq(i);else if (text.search("Standard") != -1) standardShipping = $(".shipping-speed.ship-option").eq(i);else if (text.search("Two-Day") != -1) twoDayShipping = $(".shipping-speed.ship-option").eq(i);else if (text.search("FREE") != -1) freeShipping = $(".shipping-speed.ship-option").eq(i);else console.log("One of the shipping options was not recognized");
    }

    if (studentShipping != undefined) studentShipping.css("background-color", "#EA5353");
    if (standardShipping != undefined) standardShipping.prop("style", "background-color:#7AD038;");
    if (twoDayShipping != undefined) twoDayShipping.css("background-color", "#EA5353");
    if (freeShipping != undefined) freeShipping.prop("style", "background-color:#7AD038;"); //Add speech bubble next to the shipping options
...
},{"react":"../node_modules/preact-compat/dist/preact-compat.es.js","react-dom":"../node_modules/preact-compat/dist/preact-compat.es.js","./utils":"lib/utils.js"}],"components/price_changer.js":[function(require,module,exports) {
"use strict";
...
;
main();
},{"react":"../node_modules/preact-compat/dist/preact-compat.es.js","react-dom":"../node_modules/preact-compat/dist/preact-compat.es.js","jquery":"../node_modules/jquery/dist/jquery.js","./lib/utils":"lib/utils.js","./lib/label":"lib/label.js","./lib/tooltip":"lib/tooltip.js","./lib/reformat":"lib/reformat.js","./lib/add_to_cart":"lib/add_to_cart.js","./lib/nav_cart":"lib/nav_cart.js","./lib/sort":"lib/sort.js","./lib/shipping":"lib/shipping.js","./lib/price_changer":"lib/price_changer.js","./lib/rating":"lib/rating.js","./lib/ab_test":"lib/ab_test.js","./lib/constants":"lib/constants.js"}],"../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
