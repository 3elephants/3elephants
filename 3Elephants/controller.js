...
function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react.default.createElement("div", null, "Sample Div");
    }
  }]);
...
},{"react":"../node_modules/react/index.js","./logo.svg":"logo.svg","./App.css":"App.css"}],"controller.js":[function(require,module,exports) {
"use strict";
...
function getResultsFromAPI(searchTerm, betaMode) {
  ...
  $.get(serverUrl, function (data, status) {
    ...
    } else if (productGreenRating == 0) newText = "  <span style='color:green'> Eco Friendly </span> ";else if (productGreenRating == 1) newText = "   <span style='color:red'> Not Eco Friendly <span id=\"sampleDiv\"></span> </span>";else if (productGreenRating == 2) newText = "    <span style='color:blue'> Neutral </span> ";else newText = "API return value is not valid in myscript.js";
    ...
    if (result.has_results) {
      ...
      var calculateScore = function calculateScore(score) {
        return score * 5;
      };

      tooltipHTML += "On a 5 star greenness rating scale, our sources give the product a of <span class=\"tooltiptextemphasis\">" + Number.parseFloat(calculateScore(result.score)).toFixed(1);
      tooltipHTML += "</span>. "; //data quality
      ...
      if (result.data_quality >= 2) {
        ...
        tooltipHTML += "<br> <br> Based on <span class=\"tooltiptextemphasis\">" + dQratingsMap[Math.round(result.data_quality)] + "</span> amount of data.";
      }
    ...
    _reactDom.default.render(_react.default.createElement(_App.default, null), document.getElementById('sampleDiv'));
...
var observer = new MutationObserver(function (mutations) {
  for (var i = 0; i < mutations.length; i++) {
    for (var j = 0; j < mutations[i].addedNodes.length; j++) {
      ...
      if (node.nodeType == Node.ELEMENT_NODE && node.id == MY_SELECTOR) {
...
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","./App":"App.js"}],"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
