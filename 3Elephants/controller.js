...
},{}],"original_label.js":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function (_Component) {
  _inherits(OriginalLabel, _Component);

  function OriginalLabel(props) {
    var _this;

    _classCallCheck(this, OriginalLabel);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(OriginalLabel).call(this, props));
    _this.labels = [{
      color: 'green',
      text: 'Eco Friendly'
    }, {
...
exports.createOriginal = createOriginal;
...
var _original_label = _interopRequireDefault(require("./../original_label"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function createOriginal(data) {
  var updateLogic = function updateLogic(params) {
    ...
    _reactDom.default.render(_react.default.createElement(_original_label.default, {
      data: params[0]
...
},{"react":"../node_modules/preact-compat/dist/preact-compat.es.js","react-dom":"../node_modules/preact-compat/dist/preact-compat.es.js","./utils":"lib/utils.js","./../original_label":"original_label.js"}],"original_label_tooltip.js":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function (_Component) {
  _inherits(OriginalTooltip, _Component);

  function OriginalTooltip(props) {
    var _this;

    _classCallCheck(this, OriginalTooltip);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(OriginalTooltip).call(this, props));
    _this.result = _this.props.data;
    return _this;
  } //data quality


  _createClass(OriginalTooltip, [{
    key: "render",
    value: function render() {
      var dQratingsMap = {
        2: 'Limited',
...
var _original_label_tooltip = _interopRequireDefault(require("./../original_label_tooltip"));
...
function createOriginal(data) {
  var updateLogic = function updateLogic(params) {
    ...
    _reactDom.default.render(_react.default.createElement(_original_label_tooltip.default, {
      data: params[0]
...
},{"react":"../node_modules/preact-compat/dist/preact-compat.es.js","react-dom":"../node_modules/preact-compat/dist/preact-compat.es.js","./utils":"lib/utils.js","./../original_label_tooltip":"original_label_tooltip.js"}],"lib/reformat.js":[function(require,module,exports) {
"use strict";
...
},{"./utils":"lib/utils.js"}],"controller.js":[function(require,module,exports) {
"use strict";
...
function updateUICallback(data, betaMode) {
  ...
  if (configuration.reformat.type) reformat.spaceTitleDiv();
  if (configuration.label.type) label.createOriginal(data);
  if (configuration.tooltip.type) tooltip.createOriginal(data);
  if (configuration.background_color.type) reformat.changeBackgroundColor(data);
}
...
;
main();
},{"react":"../node_modules/preact-compat/dist/preact-compat.es.js","react-dom":"../node_modules/preact-compat/dist/preact-compat.es.js","./lib/utils":"lib/utils.js","./lib/label":"lib/label.js","./lib/tooltip":"lib/tooltip.js","./lib/reformat":"lib/reformat.js"}],"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
